        ...
        with open(Devices_path,'r') as f:
           for line in f:
               if line[0]=='#':
                   ...
                   info_dict={'ip':info_list[0],'username':info_list[1],'password':info_list[2],'super':info_list[3]}
...
def run_cmd(hosts,commands):
        ...
        try:
            net_connect = ConnectHandler(device_type='hp_comware',**hosts)  #telnet主机，输入账号密码
